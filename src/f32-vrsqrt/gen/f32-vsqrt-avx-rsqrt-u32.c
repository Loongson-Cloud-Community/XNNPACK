...
void xnn_f32_vrsqrt_ukernel__avx_recip_sqrt_u32(
  ...
  for (; batch >= 32 * sizeof(float); batch -= 32 * sizeof(float)) {
    ...
    const __m256 vt2_GHIJKLMN = _mm256_mul_ps(vaGHIJKLMN, vt1_GHIJKLMN);
    const __m256 vt2_OPQRSTUV = _mm256_mul_ps(vaOPQRSTUV, vt1_OPQRSTUV);
    const __m256 vt3_01234567 = _mm256_sub_ps(kThree, vt2_01234567);
    const __m256 vt3_89ABCDEF = _mm256_sub_ps(kThree, vt2_89ABCDEF);
    const __m256 vt3_GHIJKLMN = _mm256_sub_ps(kThree, vt2_GHIJKLMN);
    const __m256 vt3_OPQRSTUV = _mm256_sub_ps(kThree, vt2_OPQRSTUV);
    const __m256 vt4_01234567 = _mm256_mul_ps(kHalf, vt0_01234567);
    const __m256 vt4_89ABCDEF = _mm256_mul_ps(kHalf, vt0_89ABCDEF);
    const __m256 vt4_GHIJKLMN = _mm256_mul_ps(kHalf, vt0_GHIJKLMN);
    const __m256 vt4_OPQRSTUV = _mm256_mul_ps(kHalf, vt0_OPQRSTUV);
