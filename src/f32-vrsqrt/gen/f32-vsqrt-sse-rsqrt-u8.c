...
void xnn_f32_vrsqrt_ukernel__sse_recip_sqrt_u8(
  ...
  for (; batch >= 8 * sizeof(float); batch -= 8 * sizeof(float)) {
    ...
    const __m128 vt0123 = _mm_sqrt_ps(vx0123);
    const __m128 vt4567 = _mm_sqrt_ps(vx4567);
    const __m128 vy0123 = _mm_div_ps(kOne, vt0123);
    const __m128 vy4567 = _mm_div_ps(kOne, vt4567);
